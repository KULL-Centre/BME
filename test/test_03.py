...
num=3
spec="train uNOE, test NOE"

# define training test
exp_train = '%s/data/uNOE_exp.dat' % (bme_path)
calc_train = '%s/data/uNOE_calc.dat' % (bme_path)

# define test set 
exp_test='%s/data/NOE_exp.dat' % (bme_path)
calc_test='%s/data/NOE_calc.dat' % (bme_path)
