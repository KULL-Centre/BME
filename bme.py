...
def parse():
    parser = argparse.ArgumentParser(
        description="This is a Bayesian/MaxEnt reweighting script"
    )

    parser.add_argument(
        "-o", dest="name", help="output_name", default=None, required=True
    )
    parser.add_argument(
        "--quiet",
        dest="quiet",
    ...
    parser.add_argument(
        "--calc",
        dest="calc_files",
        help="Back-calculated datafile (s)",
        nargs="+",
        default=None,
        required=True,
    )
